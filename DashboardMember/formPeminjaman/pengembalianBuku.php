...
<html lang="en">
  ...
  <div class="d-flex flex-wrap gap-3">
    <div class="mb-3">
      ...
      <input type="number" class="form-control" placeholder="NIM" name="nim" id="nim" value="<?= $item["nim"]; ?>" readonly>
    </div>
    <div class="mb-3">
      <label for="exampleFormControlInput1" class="form-label">Nama</label>
      <input type="text" class="form-control" placeholder="Nama" name="nama" id="nama" value=" <?= $item["nama"]; ?>" readonly>
    </div>
    <div class="mb-3">
