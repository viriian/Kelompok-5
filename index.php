...
<html lang="en">
  <head>
    ...
    <title>RMIPerpus.com</title>
    <link rel="icon" href="assets/logohd.png" type="image/png">
  </head>
  <body>
    <!--Navbar-->
  ...
  <div class="container-fluid">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold"><span class="">RMI</span>Perpus</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">RMI Perpus</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">JL Bikini Bottom</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width chaos <a href="" class="text-decoration-none">RMIPerpus</a>  2024</p>
        </div>
      </div>
    </footer>
